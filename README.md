...
## Project Structure
    ...
    ├── music_player_kelvin_29077  # Django project configurations
...
1. Clone this repo and `cd music_player_kelvin_29077`
...
2. Clone this repo and `cd music_player_kelvin_29077`
